...
import { fetchSessionCount,fetchIsCalculatedisabled } from "../action/questionnaireAction";
...
export class Home extends React.Component {
  componentWillMount() {
    ...
    this.props.dispatch(fetchIsCalculatedisabled());
  }
  render() {
    return (
          ...
          <div className="card-body">
            ...
            <Row style={{ height: "10vh" }}>
              <Col style={{ margin: "auto", textAlign: "center" }}>
                <Link to="/calculator">
                  <Button disabled={this.props.questionnaireReducer.calculateAble} onClick={this.onClickCalculateButton}>
