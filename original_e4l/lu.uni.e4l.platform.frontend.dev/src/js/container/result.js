...
//    };
 ...
 return (
      <React.Fragment>
        ...
        <div id="content-to-print">
          <div className="card ">
           ...
           <div className="card-body plot-print"  style={{ margin: '0px', padding: "0px",display:"none"}} >
            ...
            <div  id = "header" className="card-body">
             <h5 style={{ marginTop: '20px', marginBottom: '50px', textAlign: "center",fontFamily: 'sans-serif',fontWeight: "bold"}}>
              ...
              <Row>
                  <Col>
                  <div>
                    <img src={this.state.imageSources.example} className="logo-scores plot-screen" />
                    <Textfit
                      mode="single"
                ...
                <Col>
                 <div>
                 <img src={this.state.imageSources.e4l_users} className="logo-scores plot-screen" />
                 <Textfit
                  mode="single"
                  style={{ margin: "auto", textAlign: "center" }}
                  forceSingleModeWidth={false}
                 ...
                 <Col>
             <div>
                 <img src={this.state.imageSources.lux} className="logo-scores plot-screen" />
                    <Textfit
                      mode="single"
                      style={{ margin: "auto", textAlign: "center" }}
                      forceSingleModeWidth={false}
                ...
                <Col>
                  <div>
                    <img src={this.state.imageSources.europe} className="logo-scores plot-screen" />
                    <Textfit
                      mode="single"
                      style={{ margin: "auto", textAlign: "center" }}
                      forceSingleModeWidth={false}
                ...
                <Col>
                  <div>
                    <img src={this.state.imageSources.world} className="logo-scores plot-screen" />
                    <Textfit
                      mode="single"
                      style={{ margin: "auto", textAlign: "center" }}
                      forceSingleModeWidth={false}
      ...
      <div className="card-body page-print_dop" style={{ minHeight: "70px",display: 'none'}}> </div>
        <div className="card page-break">
          <div className="card-body plot-screen" style={{ minHeight: "500px",display: 'block'}}>
          ...
          <div className="card-body plot-print" style={{ width:"1120px", minHeight: "500px", display: 'none'}}>
                      <h5 style={{ textAlign: "center",fontFamily: 'sans-serif',fontWeight: "bold"}}>
                       <Trans i18nKey="result.comparison_chart_title" />
                       </h5>
                        <Row>
       ...
       <div className="card  plot-screen"  style={{ display: 'block'}}>
           <h5 style={{ textAlign: "center",fontFamily: 'sans-serif',fontWeight: "bold"}}>
      ...
      <div className="card plot-print" style={{ width:"1120px", minHeight: "500px", display: 'none'}}>
                  <h5 style={{ textAlign: "center",fontFamily: 'sans-serif',fontWeight: "bold"}}>
                   <Trans i18nKey="result.pie_chart_title" />
                   </h5>
...
//                                          }*/
        ...
        For easy access and sharing, you can scan the QR code included.                <img src={qrcode}  style={{marginLeft:"50px",width:"100px"}}/>
                ...
                <div className="card no-print" >
                      <div className="card-body" style={{ marginTop:"30px",minHeight: "70px"}}>
                      ...
                      { !this.state.show && <div className="card-body text-center" style={{ minHeight: "70px"}}>
                             <button variant="primary" onClick={this.handleShow} className="btn btn-primary"><Trans i18nKey="result.getpdf" /></button>
                        </div>}
                        </div>
                      </div>
